...
var didYouSwitch = true;

while (didYouSwitch) {
  var didYouSwitch = false;
  for (var i = 0; i < numbers.length; i++){
    var NextNumIndex = i - 1;
    var NextNumVal = numbers[NextNumIndex]
    var currentNumVal

    //if number biger switch
    if(numbers[i] < NextNumVal){
      // console.log("switch " + numbers[i] + " " + NextNumVal);

      //switch
      //next into firstNumber
      numbers[NextNumIndex] = numbers[i];
      numbers[i] = NextNumVal;
      didYouSwitch = true;
    }
