...
while True:
    ...
    student['first_name'] = raw_input('Please enter the student\'s first name. ')
    student['last_name'] = raw_input('Please enter the student\'s last name. ')
    student['middle_initial'] = raw_input('Please enter the student\'s middle initial. ')
    
    # Prompt user for student's contact information...
    student['address'] = raw_input('Please enter the student\'s address. ')
    student['email'] = raw_input('Please enter the student\'s email. ')
    student['phone_number'] = raw_input('Please enter the student\'s phone_number. ')
    ...
    if raw_input('Is this information correct? (Y/n) ').lower() == 'y':
